...
- All Clients now supports richer directory controls: **Status/Entity/Assigned Staff** filters, **A→Z/Z→A name sorting**, and split **First Name / Last Name** columns for clearer firm-style client records.
